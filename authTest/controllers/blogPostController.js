import {BlogModel as Blog} from '../models/index.js'
...
export async function createBlogPost(req, res) {
    ...
    if (postImage){
        ...
        const post = await Blog.create({userId: user.userId, title: title, content: content, picture: `/static/uploads/${localImage}`})
        return res.json(response(res, post, null, StatusCodes.CREATED, null));
    }
    const post = await Blog.create({userId: user.userId, title: title, content: content, picture: null})
    return res.json(response(res, post, null, StatusCodes.CREATED, null));
